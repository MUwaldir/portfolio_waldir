      ...
      <div className="flex flex-col md:flex-row ">
        <div className="md:w-1/3 md:px-10">
          <img
            ...
            src="https://media.licdn.com/dms/image/C4D03AQEXuXQ3meP68A/profile-displayphoto-shrink_800_800/0/1645632557336?e=1714608000&v=beta&t=Y0pbzHMJp3C4YrAcdp2DLcbrYMkO1phSXCthMlyzeCc"
            alt="Profile Picture"
            className="w-full h-64 object-scale-down md:object-contain rounded-full mb-4 ease-in-out hover:opacity-75 hover:scale-105 transition duration-300"
          />
          <h2 className="text-2xl font-bold mb-2">Waldir Merjildo</h2>
          <p className="text-gray-600">systems engineer</p>
          <div className="flex space-x-2 mt-4">
            <SocialLink
              ...
              className="text-gray-500 hover:text-gray-700 hover:scale-150"
            />
            <SocialLink
        ...
        <div className="md:w-2/3 text-justify px-2">
          <p className="text-lg text-gray-700 transition duration-300 hover:text-blue-500 ">
